...
set xlabel "Running time (in hours)"
...
plot \
   'cgstat.log' using ($1/(60*60)):($3/(100*10**7)) title 'CPU time used' with lines ls 8,  \
   'cgstat.log' using ($1/(60*60)):($2/(1024*1024*1024)) axes x1y2 title 'Memory used' with lines ls 1
