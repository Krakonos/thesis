...
set output "firefox-ipa-kpta.png"
...
set y2label "Memory used (in GB)" textcolor rgbcolor '#74ADD1'
...
plot \
   'cgstat.log' using ($2/(1024*1024*1024)) axes x1y2 title 'Memory used' with lines ls 4, \
   'cgstat.log' using ($3/(100*10**7)) title 'CPU time used' with lines ls 8

set terminal epslatex standalone color colortext
set output "firefox-ipa-kpta.tex"
